...
static struct dvfs core_dvfs_table[] = {
	...
	CORE_DVFS("cpu_lp", 0, 1, KHZ,        1, 294000, 342000, 427000, 475000,  500000,  550000,  600000,  660000),
	CORE_DVFS("cpu_lp", 1, 1, KHZ,   204000, 294000, 342000, 427000, 475000,  500000,  550000,  600000,  660000),
	CORE_DVFS("cpu_lp", 2, 1, KHZ,   204000, 295000, 370000, 428000, 475000,  513000,  579000,  620000,  660000),
	CORE_DVFS("cpu_lp", 3, 1, KHZ,        1,      1,      1,      1,      1,       1,  450000,  450000,  520000),
...
/* Core voltages (mV):		           950,   1000,   1050,   1100,   1150,    1200,    1250,    1300,    1350 */
	...
	CORE_DVFS("vde", gpuc_mv_table,   0, 1, KHZ,        1, 228000, 275000, 332000, 380000,  446000,  446000,  446000,  446000),
	CORE_DVFS("mpe", gpuc_mv_table,   0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  446000,  446000,  446000,  446000),
	CORE_DVFS("2d",  gpuc_mv_table,   0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  446000,  446000,  446000,  446000),
	CORE_DVFS("epp", gpuc_mv_table,   0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  446000,  446000,  446000,  446000),
	CORE_DVFS("3d",  gpuc_mv_table,   0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  446000,  446000,  446000,  446000),
	CORE_DVFS("3d2", gpuc_mv_table,   0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  446000,  446000,  446000,  446000),
	CORE_DVFS("se",  gpuc_mv_table,   0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  446000,  446000,  446000,  446000),

	CORE_DVFS("vde", gpuc_mv_table,   1, 1, KHZ,        1, 228000, 275000, 332000, 380000,  446000,  446000,  446000,  446000),
	CORE_DVFS("mpe", gpuc_mv_table,   1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  446000,  446000,  446000,  446000),
	CORE_DVFS("2d",  gpuc_mv_table,   1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  446000,  446000,  446000,  446000),
	CORE_DVFS("epp", gpuc_mv_table,   1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  446000,  446000,  446000,  446000),
	CORE_DVFS("3d",  gpuc_mv_table,   1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  446000,  446000,  446000,  446000),
	CORE_DVFS("3d2", gpuc_mv_table,   1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  446000,  446000,  446000,  446000),
	CORE_DVFS("se",  gpuc_mv_table,   1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  446000,  446000,  446000,  446000),
#endif
#ifdef CONFIG_GPU_OC_484
	CORE_DVFS("vde", gpuc_mv_table,   0, 1, KHZ,        1, 228000, 275000, 332000, 380000,  484000,  484000,  484000,  484000),
	CORE_DVFS("mpe", gpuc_mv_table,   0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  484000,  484000,  484000,  484000),
	CORE_DVFS("2d",  gpuc_mv_table,   0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  484000,  484000,  484000,  484000),
	CORE_DVFS("epp", gpuc_mv_table,   0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  484000,  484000,  484000,  484000),
	CORE_DVFS("3d",  gpuc_mv_table,   0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  484000,  484000,  484000,  484000),
	CORE_DVFS("3d2", gpuc_mv_table,   0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  484000,  484000,  484000,  484000),
	CORE_DVFS("se",  gpuc_mv_table,   0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  484000,  484000,  484000,  484000),

	CORE_DVFS("vde", gpuc_mv_table,   1, 1, KHZ,        1, 228000, 275000, 332000, 380000,  484000,  484000,  484000,  484000),
	CORE_DVFS("mpe", gpuc_mv_table,   1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  484000,  484000,  484000,  484000),
	CORE_DVFS("2d",  gpuc_mv_table,   1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  484000,  484000,  484000,  484000),
	CORE_DVFS("epp", gpuc_mv_table,   1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  484000,  484000,  484000,  484000),
	CORE_DVFS("3d",  gpuc_mv_table,   1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  484000,  484000,  484000,  484000),
	CORE_DVFS("3d2", gpuc_mv_table,   1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  484000,  484000,  484000,  484000),
	CORE_DVFS("se",  gpuc_mv_table,   1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  484000,  484000,  484000,  484000),
#endif
#ifdef CONFIG_GPU_OC_520
	CORE_DVFS("vde", gpuc_mv_table,   0, 1, KHZ,        1, 228000, 275000, 332000, 380000,  484000,  520000,  660000,  700000),
	CORE_DVFS("mpe", gpuc_mv_table,   0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  484000,  520000,  660000,  700000),
	CORE_DVFS("2d",  gpuc_mv_table,   0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  484000,  520000,  660000,  700000),
	CORE_DVFS("epp", gpuc_mv_table,   0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  484000,  520000,  660000,  700000),
	CORE_DVFS("3d",  gpuc_mv_table,   0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  484000,  520000,  660000,  700000),
	CORE_DVFS("3d2", gpuc_mv_table,   0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  484000,  520000,  660000,  700000),
	CORE_DVFS("se",  gpuc_mv_table,   0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  484000,  520000,  660000,  700000),

	CORE_DVFS("vde", gpuc_mv_table,   1, 1, KHZ,        1, 228000, 275000, 332000, 380000,  520000,  600000,  660000,  700000),
	CORE_DVFS("mpe", gpuc_mv_table,   1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  520000,  600000,  660000,  700000),
	CORE_DVFS("2d",  gpuc_mv_table,   1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  520000,  600000,  660000,  700000),
	CORE_DVFS("epp", gpuc_mv_table,   1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  520000,  600000,  660000,  700000),
	CORE_DVFS("3d",  gpuc_mv_table,   1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  520000,  600000,  660000,  700000),
	CORE_DVFS("3d2", gpuc_mv_table,   1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  520000,  600000,  660000,  700000),
	CORE_DVFS("se",  gpuc_mv_table,   1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  520000,  600000,  660000,  700000),
#endif
#else
	CORE_DVFS("vde", gpuc_mv_table,   0, 1, KHZ,        1, 228000, 275000, 332000, 380000,  416000,  416000,  416000,  416000),
	CORE_DVFS("mpe", gpuc_mv_table,   0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  416000,  416000,  416000,  416000),
	CORE_DVFS("2d",  gpuc_mv_table,   0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  416000,  416000,  416000,  416000),
	CORE_DVFS("epp", gpuc_mv_table,   0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  416000,  416000,  416000,  416000),
	CORE_DVFS("3d",  gpuc_mv_table,   0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  416000,  416000,  416000,  416000),
	CORE_DVFS("3d2", gpuc_mv_table,   0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  416000,  416000,  416000,  416000),
	CORE_DVFS("se",  gpuc_mv_table,   0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  416000,  416000,  416000,  416000),

	CORE_DVFS("vde", gpuc_mv_table,   1, 1, KHZ,        1, 228000, 275000, 332000, 380000,  416000,  416000,  416000,  416000),
	CORE_DVFS("mpe", gpuc_mv_table,   1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  416000,  416000,  416000,  416000),
	CORE_DVFS("2d",  gpuc_mv_table,   1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  416000,  416000,  416000,  416000),
	CORE_DVFS("epp", gpuc_mv_table,   1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  416000,  416000,  416000,  416000),
	CORE_DVFS("3d",  gpuc_mv_table,   1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  416000,  416000,  416000,  416000),
	CORE_DVFS("3d2", gpuc_mv_table,   1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  416000,  416000,  416000,  416000),
	CORE_DVFS("se",  gpuc_mv_table,   1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  416000,  416000,  416000,  416000),
#endif

	CORE_DVFS("vde", gpuc_mv_table,   2, 1, KHZ,        1, 247000, 304000, 352000, 400000,  437000,  484000,  520000,  600000),
	CORE_DVFS("mpe", gpuc_mv_table,   2, 1, KHZ,        1, 247000, 304000, 361000, 408000,  446000,  484000,  520000,  600000),
	CORE_DVFS("2d",  gpuc_mv_table,   2, 1, KHZ,        1, 267000, 304000, 361000, 408000,  446000,  484000,  520000,  600000),
	CORE_DVFS("epp", gpuc_mv_table,   2, 1, KHZ,        1, 267000, 304000, 361000, 408000,  446000,  484000,  520000,  600000),
	CORE_DVFS("3d",  gpuc_mv_table,   2, 1, KHZ,        1, 247000, 304000, 361000, 408000,  446000,  484000,  520000,  600000),
	CORE_DVFS("3d2", gpuc_mv_table,   2, 1, KHZ,        1, 247000, 304000, 361000, 408000,  446000,  484000,  520000,  600000),
	CORE_DVFS("se",  gpuc_mv_table,   2, 1, KHZ,        1, 267000, 304000, 361000, 408000,  446000,  484000,  520000,  600000),

	CORE_DVFS("vde", gpuc_mv_table,   3, 1, KHZ,        1,      1,      1,      1,      1,       1,  484000,  484000,  484000),
	CORE_DVFS("mpe", gpuc_mv_table,   3, 1, KHZ,        1,      1,      1,      1,      1,       1,  484000,  484000,  484000),
	CORE_DVFS("2d",  gpuc_mv_table,   3, 1, KHZ,        1,      1,      1,      1,      1,       1,  484000,  484000,  484000),
	CORE_DVFS("epp", gpuc_mv_table,   3, 1, KHZ,        1,      1,      1,      1,      1,       1,  484000,  484000,  484000),
	CORE_DVFS("3d",  gpuc_mv_table,   3, 1, KHZ,        1,      1,      1,      1,      1,       1,  484000,  484000,  484000),
	CORE_DVFS("3d2", gpuc_mv_table,   3, 1, KHZ,        1,      1,      1,      1,      1,       1,  484000,  484000,  484000),
	CORE_DVFS("se",  gpuc_mv_table,   3, 1, KHZ,        1,      1,      1,      1,      1,       1,  625000,  625000,  625000),
...
#endif
#ifdef CONFIG_GPU_OC_520
	CORE_DVFS("cbus",   0, 1, KHZ,        1, 228000, 275000, 332000, 380000,  484000,  520000,  660000,  700000),
	CORE_DVFS("cbus",   1, 1, KHZ,        1, 228000, 275000, 332000, 380000,  484000,  520000,  660000,  700000),
	CORE_DVFS("cbus",   2, 1, KHZ,        1, 247000, 304000, 352000, 400000,  437000,  520000,  660000,  700000),
	CORE_DVFS("cbus",   3, 1, KHZ,        1, 484000, 484000, 484000, 484000,  484000,  484000,  484000,  484000),
#endif
#else
