...
/* Core voltages (mV):		           950,   1000,   1050,   1100,   1150,    1200,    1250,    1300,    1350 */
	...
	CORE_DVFS("vde",    1, 1, KHZ,        1, 228000, 275000, 332000, 380000,  700000,  700000,  700000,  700000),
	CORE_DVFS("mpe",    1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  700000,  700000,  700000,  700000),
	CORE_DVFS("2d",     1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  700000,  700000,  700000,  700000),
	CORE_DVFS("epp",    1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  700000,  700000,  700000,  700000),
	CORE_DVFS("3d",     1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  700000,  700000,  700000,  700000),
	CORE_DVFS("3d2",    1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  700000,  700000,  700000,  700000),
	CORE_DVFS("se",     1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  700000,  700000,  700000,  700000),
#endif
#ifdef CONFIG_GPU_OC_600
	CORE_DVFS("vde",    0, 1, KHZ,        1, 228000, 275000, 332000, 380000,  600000,  600000,  600000,  600000),
	CORE_DVFS("mpe",    0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  600000,  600000,  600000,  600000),
	CORE_DVFS("2d",     0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  600000,  600000,  600000,  600000),
	CORE_DVFS("epp",    0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  600000,  600000,  600000,  600000),
	CORE_DVFS("3d",     0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  600000,  600000,  600000,  600000),
	CORE_DVFS("3d2",    0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  600000,  600000,  600000,  600000),
	CORE_DVFS("se",     0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  600000,  600000,  600000,  600000),	
	
	CORE_DVFS("vde",    1, 1, KHZ,        1, 228000, 275000, 332000, 380000,  600000,  600000,  600000,  600000),
	CORE_DVFS("mpe",    1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  600000,  600000,  600000,  600000),
	CORE_DVFS("2d",     1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  600000,  600000,  600000,  600000),
	CORE_DVFS("epp",    1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  600000,  600000,  600000,  600000),
	CORE_DVFS("3d",     1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  600000,  600000,  600000,  600000),
	CORE_DVFS("3d2",    1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  600000,  600000,  600000,  600000),
	CORE_DVFS("se",     1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  600000,  600000,  600000,  600000),
#endif
#ifdef CONFIG_GPU_OC_660
	CORE_DVFS("vde",    0, 1, KHZ,        1, 228000, 275000, 332000, 380000,  666000,  666000,  666000,  666000),
	CORE_DVFS("mpe",    0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  666000,  666000,  666000,  666000),
	CORE_DVFS("2d",     0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  666000,  666000,  666000,  666000),
	CORE_DVFS("epp",    0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  666000,  666000,  666000,  666000),
	CORE_DVFS("3d",     0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  666000,  666000,  666000,  666000),
	CORE_DVFS("3d2",    0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  666000,  666000,  666000,  666000),
	CORE_DVFS("se",     0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  666000,  666000,  666000,  666000),	
	
	CORE_DVFS("vde",    1, 1, KHZ,        1, 228000, 275000, 332000, 380000,  666000,  666000,  666000,  666000),
	CORE_DVFS("mpe",    1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  666000,  666000,  666000,  666000),
	CORE_DVFS("2d",     1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  666000,  666000,  666000,  666000),
	CORE_DVFS("epp",    1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  666000,  666000,  666000,  666000),
	CORE_DVFS("3d",     1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  666000,  666000,  666000,  666000),
	CORE_DVFS("3d2",    1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  666000,  666000,  666000,  666000),
	CORE_DVFS("se",     1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  666000,  666000,  666000,  666000),
#endif
#ifdef CONFIG_GPU_OC_700
	CORE_DVFS("vde",    0, 1, KHZ,        1, 228000, 275000, 332000, 380000,  700000,  700000,  700000,  700000),
	CORE_DVFS("mpe",    0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  700000,  700000,  700000,  700000),
	CORE_DVFS("2d",     0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  700000,  700000,  700000,  700000),
	CORE_DVFS("epp",    0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  700000,  700000,  700000,  700000),
	CORE_DVFS("3d",     0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  700000,  700000,  700000,  700000),
	CORE_DVFS("3d2",    0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  700000,  700000,  700000,  700000),
	CORE_DVFS("se",     0, 1, KHZ,        1, 267000, 285000, 332000, 700000,  700000,  700000,  700000,  700000),
...
#ifdef CONFIG_GPU_OC_446
	CORE_DVFS("host1x", 1, 1, KHZ,        1, 152000, 188000, 222000, 223000,  223000,  223000,  223000,  223000),
#endif
#ifdef CONFIG_GPU_OC_484
	CORE_DVFS("host1x", 1, 1, KHZ,        1, 152000, 188000, 222000, 223000,  242000,  242000,  242000,  242000),
#endif
#ifdef CONFIG_GPU_OC_520
	CORE_DVFS("host1x", 1, 1, KHZ,        1, 152000, 188000, 222000, 254000,  260000,  260000,  260000,  260000),
#endif
#ifdef CONFIG_GPU_OC_600
	CORE_DVFS("host1x", 1, 1, KHZ,        1, 152000, 188000, 222000, 254000,  300000,  300000,  300000,  300000),
#endif
#ifdef CONFIG_GPU_OC_660
	CORE_DVFS("host1x", 1, 1, KHZ,        1, 152000, 188000, 222000, 254000,  330000,  330000,  330000,  330000),
#endif
#ifdef CONFIG_GPU_OC_700
	CORE_DVFS("host1x", 1, 1, KHZ,        1, 152000, 188000, 222000, 254000,  350000,  350000,  350000,  350000),
#endif
...
#endif
#ifdef CONFIG_GPU_OC_600
	CORE_DVFS("cbus",   0, 1, KHZ,        1, 228000, 275000, 332000, 380000,  600000,  600000,  600000,  600000),
	CORE_DVFS("cbus",   1, 1, KHZ,        1, 228000, 275000, 332000, 380000,  600000,  600000,  600000,  600000),
	CORE_DVFS("cbus",   2, 1, KHZ,        1, 247000, 304000, 352000, 400000,  437000,  484000,  520000,  600000),
	CORE_DVFS("cbus",   3, 1, KHZ,        1, 484000, 484000, 484000, 484000,  484000,  484000,  484000,  484000),
#endif
#ifdef CONFIG_GPU_OC_660
	CORE_DVFS("cbus",   0, 1, KHZ,        1, 228000, 275000, 332000, 380000,  660000,  660000,  660000,  660000),
	CORE_DVFS("cbus",   1, 1, KHZ,        1, 228000, 275000, 332000, 380000,  660000,  660000,  660000,  660000),
	CORE_DVFS("cbus",   2, 1, KHZ,        1, 247000, 304000, 352000, 400000,  437000,  484000,  520000,  600000),
	CORE_DVFS("cbus",   3, 1, KHZ,        1, 484000, 484000, 484000, 484000,  484000,  484000,  484000,  484000),
#endif
#ifdef CONFIG_GPU_OC_700
	CORE_DVFS("cbus",   0, 1, KHZ,        1, 228000, 275000, 332000, 380000,  700000,  700000,  700000,  700000),
	CORE_DVFS("cbus",   1, 1, KHZ,        1, 228000, 275000, 332000, 380000,  700000,  700000,  700000,  700000),
	CORE_DVFS("cbus",   2, 1, KHZ,        1, 247000, 304000, 352000, 400000,  437000,  484000,  520000,  600000),
	CORE_DVFS("cbus",   3, 1, KHZ,        1, 484000, 484000, 484000, 484000,  484000,  484000,  484000,  484000),
#endif
#else
...
#ifdef CONFIG_GPU_OVERCLOCK
#ifdef CONFIG_GPU_OC_446
	CORE_DVFS("pll_c",  -1, 1, KHZ,  533000, 667000, 667000, 800000, 800000, 892000, 892000, 892000, 892000),
#endif
#ifdef CONFIG_GPU_OC_484
	CORE_DVFS("pll_c",  -1, 1, KHZ,  533000, 667000, 667000, 800000, 800000, 968000, 968000, 968000, 968000),
#endif
#ifdef CONFIG_GPU_OC_520
	CORE_DVFS("pll_c",  -1, 1, KHZ,  533000, 667000, 667000, 800000, 800000, 1040000, 1040000, 1040000, 1040000),
#endif
#ifdef CONFIG_GPU_OC_600
	CORE_DVFS("pll_c",  -1, 1, KHZ,  533000, 667000, 667000, 800000, 800000, 1200000, 1200000, 1200000, 1200000),
#endif
#ifdef CONFIG_GPU_OC_660
	CORE_DVFS("pll_c",  -1, 1, KHZ,  533000, 667000, 667000, 800000, 800000, 1332000, 1332000, 1332000, 1332000),
#endif
#ifdef CONFIG_GPU_OC_700
	CORE_DVFS("pll_c",  -1, 1, KHZ,  533000, 667000, 667000, 800000, 800000, 1400000, 1400000, 1400000, 1400000),
#endif
#else
